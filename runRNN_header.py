...
tf.flags.DEFINE_string("tensorboard_dir", "tensorboard_dir/textRNN_header", "saving path of tensorboard")
tf.flags.DEFINE_string("save_dir", "checkpoints/textRNN_header", "save base dir")
