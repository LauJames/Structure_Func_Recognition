...
tf.flags.DEFINE_string("tensorboard_dir", "tensorboard_dir/textRNN_section", "saving path of tensorboard")
tf.flags.DEFINE_string("save_dir", "checkpoints/textRNN_section", "save base dir")

# Model Hyperparameters
tf.flags.DEFINE_integer("embedding_dim", 256, "Dimensionality of character embedding (default: 128)")
tf.flags.DEFINE_integer("seq_length", 119396, "sequence length (default: 600)")
