...
tf.flags.DEFINE_string("tensorboard_dir", "tensorboard_dir/textCNN_para", "saving path of tensorboard")
tf.flags.DEFINE_string("save_dir", "checkpoints/textCNN_para", "save base dir")
